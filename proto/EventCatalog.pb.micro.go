...
func NewEventCatalogEndpoints() []*api.Endpoint {
	return []*api.Endpoint{
		{
			Name:    "EventCatalog.CreateEventWithCategory",
			Path:    []string{"/api/event-catalogs"},
			Method:  []string{"POST"},
			Body:    "*",
			Handler: "rpc",
		},
		{
			Name:    "EventCatalog.GetEventByField",
			Path:    []string{"/api/event-catalogs/fields"},
			Method:  []string{"GET"},
			Handler: "rpc",
		},
		{
			Name:    "EventCatalog.GetAllEvents",
			Path:    []string{"/api/event-catalogs"},
			Method:  []string{"GET"},
			Handler: "rpc",
		},
		{
			Name:    "EventCatalog.GetEventById",
			Path:    []string{"/api/event-catalogs/{id}"},
			Method:  []string{"GET"},
			Handler: "rpc",
		},
		{
			Name:    "EventCatalog.GetAllCategories",
			Path:    []string{"/api/categories"},
			Method:  []string{"GET"},
			Handler: "rpc",
		},
		{
			Name:    "EventCatalog.UpdateEvent",
			Path:    []string{"/api/event-catalogs"},
			Method:  []string{"PUT"},
			Body:    "",
			Handler: "rpc",
		...
		{
			Name:    "EventCatalog.DeleteEventById",
			Path:    []string{"/api/event-catalogs/{id}"},
		...
		{
			Name:    "EventCatalog.CreateCategory",
			Path:    []string{"/api/categories"},
			Method:  []string{"POST"},
			Body:    "",
			Handler: "rpc",
