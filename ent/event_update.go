...
func (eu *EventUpdate) SetPrice(f float32) *EventUpdate {
...
func (eu *EventUpdate) AddPrice(f float32) *EventUpdate {
	eu.mutation.AddPrice(f)
	return eu
}

// SetArtist sets the "Artist" field.
func (eu *EventUpdate) SetArtist(s string) *EventUpdate {
	eu.mutation.SetArtist(s)
	return eu
}

// SetDate sets the "Date" field.
func (eu *EventUpdate) SetDate(i int64) *EventUpdate {
	eu.mutation.ResetDate()
	eu.mutation.SetDate(i)
	return eu
}

// AddDate adds i to the "Date" field.
func (eu *EventUpdate) AddDate(i int64) *EventUpdate {
	eu.mutation.AddDate(i)
	return eu
}
...
func (eu *EventUpdate) SetOwner(c *Category) *EventUpdate {
	return eu.SetOwnerID(c.ID)
}
...
func (eu *EventUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := eu.mutation.Artist(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: event.FieldArtist,
		})
	}
	...
	if value, ok := eu.mutation.AddedDate(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt64,
			Value:  value,
			Column: event.FieldDate,
...
// SetPrice sets the "Price" field.
func (euo *EventUpdateOne) SetPrice(f float32) *EventUpdateOne {
...
// AddPrice adds f to the "Price" field.
func (euo *EventUpdateOne) AddPrice(f float32) *EventUpdateOne {
	euo.mutation.AddPrice(f)
	return euo
}

// SetArtist sets the "Artist" field.
func (euo *EventUpdateOne) SetArtist(s string) *EventUpdateOne {
	euo.mutation.SetArtist(s)
	return euo
}

// SetDate sets the "Date" field.
func (euo *EventUpdateOne) SetDate(i int64) *EventUpdateOne {
	euo.mutation.ResetDate()
	euo.mutation.SetDate(i)
	return euo
}

// AddDate adds i to the "Date" field.
func (euo *EventUpdateOne) AddDate(i int64) *EventUpdateOne {
	euo.mutation.AddDate(i)
	return euo
}
...
// SetOwner sets the "owner" edge to the Category entity.
func (euo *EventUpdateOne) SetOwner(c *Category) *EventUpdateOne {
	return euo.SetOwnerID(c.ID)
}
...
func (euo *EventUpdateOne) sqlSave(ctx context.Context) (_node *Event, err error) {
	...
	if value, ok := euo.mutation.Artist(); ok {
		_spec.Fields.Set = append(_spec.Fields.Set, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
			Column: event.FieldArtist,
	...
	if value, ok := euo.mutation.AddedDate(); ok {
		_spec.Fields.Add = append(_spec.Fields.Add, &sqlgraph.FieldSpec{
			Type:   field.TypeInt64,
			Value:  value,
			Column: event.FieldDate,
