...
func (cu *CategoryUpdate) SetName(c category.Name) *CategoryUpdate {
	cu.mutation.SetName(c)
	return cu
}

// AddEventIDs adds the "Events" edge to the Event entity by IDs.
func (cu *CategoryUpdate) AddEventIDs(ids ...uuid.UUID) *CategoryUpdate {
	cu.mutation.AddEventIDs(ids...)
	return cu
}

// AddEvents adds the "Events" edges to the Event entity.
func (cu *CategoryUpdate) AddEvents(e ...*Event) *CategoryUpdate {
...
func (cu *CategoryUpdate) ClearEvents() *CategoryUpdate {
	cu.mutation.ClearEvents()
	return cu
}

// RemoveEventIDs removes the "Events" edge to Event entities by IDs.
func (cu *CategoryUpdate) RemoveEventIDs(ids ...uuid.UUID) *CategoryUpdate {
	cu.mutation.RemoveEventIDs(ids...)
	return cu
}

// RemoveEvents removes "Events" edges to Event entities.
func (cu *CategoryUpdate) RemoveEvents(e ...*Event) *CategoryUpdate {
	ids := make([]uuid.UUID, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
...
func (cu *CategoryUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if cu.mutation.EventsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   category.EventsTable,
			Columns: []string{category.EventsColumn},
			Bidi:    false,
...
// SetName sets the "Name" field.
func (cuo *CategoryUpdateOne) SetName(c category.Name) *CategoryUpdateOne {
	cuo.mutation.SetName(c)
	return cuo
}

// AddEventIDs adds the "Events" edge to the Event entity by IDs.
func (cuo *CategoryUpdateOne) AddEventIDs(ids ...uuid.UUID) *CategoryUpdateOne {
	cuo.mutation.AddEventIDs(ids...)
	return cuo
}

// AddEvents adds the "Events" edges to the Event entity.
func (cuo *CategoryUpdateOne) AddEvents(e ...*Event) *CategoryUpdateOne {
	ids := make([]uuid.UUID, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
...
// ClearEvents clears all "Events" edges to the Event entity.
func (cuo *CategoryUpdateOne) ClearEvents() *CategoryUpdateOne {
	cuo.mutation.ClearEvents()
	return cuo
}

// RemoveEventIDs removes the "Events" edge to Event entities by IDs.
func (cuo *CategoryUpdateOne) RemoveEventIDs(ids ...uuid.UUID) *CategoryUpdateOne {
	cuo.mutation.RemoveEventIDs(ids...)
	return cuo
}

// RemoveEvents removes "Events" edges to Event entities.
func (cuo *CategoryUpdateOne) RemoveEvents(e ...*Event) *CategoryUpdateOne {
	ids := make([]uuid.UUID, len(e))
	for i := range e {
		ids[i] = e[i].ID
	}
