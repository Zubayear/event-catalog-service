...
func (ec *EventCreate) SetPrice(f float32) *EventCreate {
	ec.mutation.SetPrice(f)
	return ec
}

// SetArtist sets the "Artist" field.
func (ec *EventCreate) SetArtist(s string) *EventCreate {
	ec.mutation.SetArtist(s)
	return ec
}

// SetDate sets the "Date" field.
func (ec *EventCreate) SetDate(i int64) *EventCreate {
	ec.mutation.SetDate(i)
	return ec
}
...
func (ec *EventCreate) SetOwner(c *Category) *EventCreate {
	return ec.SetOwnerID(c.ID)
}
...
func (ec *EventCreate) check() error {
	...
	if _, ok := ec.mutation.Price(); !ok {
		return &ValidationError{Name: "Price", err: errors.New(`ent: missing required field "Event.Price"`)}
	}
	if _, ok := ec.mutation.Artist(); !ok {
		return &ValidationError{Name: "Artist", err: errors.New(`ent: missing required field "Event.Artist"`)}
	}
	...
	if _, ok := ec.mutation.ImageUrl(); !ok {
		return &ValidationError{Name: "ImageUrl", err: errors.New(`ent: missing required field "Event.ImageUrl"`)}
	}
	return nil
}
...
func (ec *EventCreate) createSpec() (*Event, *sqlgraph.CreateSpec) {
	...
	if value, ok := ec.mutation.Artist(); ok {
		_spec.Fields = append(_spec.Fields, &sqlgraph.FieldSpec{
			Type:   field.TypeString,
			Value:  value,
