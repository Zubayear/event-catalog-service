...
func (cc *CategoryCreate) SetName(c category.Name) *CategoryCreate {
...
func (cc *CategoryCreate) AddEventIDs(ids ...uuid.UUID) *CategoryCreate {
	cc.mutation.AddEventIDs(ids...)
	return cc
}

// AddEvents adds the "Events" edges to the Event entity.
func (cc *CategoryCreate) AddEvents(e ...*Event) *CategoryCreate {
